...
<head>
    ...
    <link rel="icon" href="{{asset('front-end-assets')}}/img/logo-copy.png" type="image/x-icon">
    <title>Nokkhotro Tower</title>
    ...
    <link rel="shortcut icon" href="{{asset('front-end-assets')}}/img/logo-copy.png" />
